...
def get_model_directory() -> Path:
    ...
    if _model_dir is None:
        ...
        # Since this file is now at ml-service/prehire-attrition/loader.py
        # The model directory is simply in the same folder under 'model/'
        _model_dir = current_file.parent / "model"
